...
// Split big elements in shorter ones
function splitBigElements(elements) {
  // Some elements are too long. We need to make sure any element has a maximum
  // size.
  // Like if more than 450 chars, we split below 450 chars, but still keeping
  // full sentences.
}
